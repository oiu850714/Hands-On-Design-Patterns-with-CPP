...
static_assert(sizeof(have_sort) != sizeof(have_nothing),
...
template <typename T> struct fast_sort_helper<T, sizeof(have_sort)> {
...
template <typename T> struct fast_sort_helper<T, sizeof(have_range)> {
  static void fast_sort(T &x) {
...
template <typename T> struct fast_sort_helper<T, sizeof(have_nothing)> {
  static void fast_sort(T &x) {
