...
void check_default_constructible(int i, double x, int *p, const A &a,
  ...
  static_assert(decltype(is_default_constructible(i))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(x))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(p))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(a))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(b))::value,
                "Feature check failed");
  static_assert(!decltype(is_default_constructible(c))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(d))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(e))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(ptr))::value,
                "Feature check failed");
  static_assert(decltype(is_default_constructible(iptr))::value,
                "Feature check failed");
}

void check_copyable(int i, double x, int *p, const A &a, const B &b, const C &c,
                    const D &d, const E &e, const Ptr &ptr,
                    const SmartPtr<int> &iptr) {
...
void check_destructible(int i, double x, int *p, const A &a, const B &b,
                        const C &c, const D &d, const E &e, const Ptr &ptr,
                        const SmartPtr<int> &iptr) {
...
void check_assignable(int i, double x, int *p, const A &a, const B &b,
                      const C &c, const D &d, const E &e, const Ptr &ptr,
                      const SmartPtr<int> &iptr) {
...
void check_assignable0(int i, double x, int *p, const A &a, const B &b,
                       const C &c, const D &d, const E &e, const Ptr &ptr,
                       const SmartPtr<int> &iptr) {
...
void check_addable2(int i, double x, int *p, const A &a, const B &b, const C &c,
                    const D &d, const E &e, const Ptr &ptr,
                    const SmartPtr<int> &iptr) {
