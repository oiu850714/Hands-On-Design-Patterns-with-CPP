...
template <typename T> void BM_string_create_short(benchmark::State &state) {
...
template <typename T> void BM_string_copy_short(benchmark::State &state) {
...
template <typename T> void BM_string_assign_short(benchmark::State &state) {
  const T s("Simple string");
  T S;
  for (auto _ : state) {
...
template <typename T> void BM_string_compare_short(benchmark::State &state) {
...
template <typename T> void BM_string_create_long(benchmark::State &state) {
