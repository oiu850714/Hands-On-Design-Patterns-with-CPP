...
public:
  ...
  static void Register() { ::RegisterBuilding(Castle::MakeBuilding); }
...
public:
  ...
  static void Register() { ::RegisterBuilding(Tower::MakeBuilding); }
...
public:
  ...
  static void Register() { ::RegisterBuilding(Mound::MakeBuilding); }
